...
public:
	...
	constexpr static auto supported_targets = {Target::hardware_non_interactive};
...
template <typename ConnectionParameter, typename RcfClient>
class Stream<QuiggeldyConnection<ConnectionParameter, RcfClient>>
{
public:
	using has_full_stream_interface = std::false_type;
};
